<?php
  ...
  $sql = "SELECT * FROM draft_story WHERE id_story=$id_story";
...
<html>
  ...
  <body>
  	...
  	<div class="container-fluid my-3">
  		...
  		<h5 class="display-5 text-center fw-bold"><?php echo $series_note ?> Series</h3>
  		<div class="note-option text-center mx-auto">
  			...
  			<span class="mx-2"><a href="editnote.php?id_story=<?php echo $id_story ?>"><i class="fas fa-edit text-primary"></i></a></span>
  			<span class="mx-2"><a href="deletenote.php?id_story=<?php echo $id_story ?>"><i class="fas fa-trash text-danger"></i></a></span>
  		</div>
  	</div>
  	<hr>
  	<div class="container-fluid my-3">
